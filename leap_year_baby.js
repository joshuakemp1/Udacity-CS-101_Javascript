...
function output(day, month, year, name) {
    if (year % 4 === 0 && month === 2 && day === 29 ) {
        if (year % 100) {
        }
        else if (year % 400 === 0) {
          console.log(name + " is one of an extremely rare species. He is a leap year baby!");
        }
        else {
          console.log("There's nothing special about" + name +"'s birthday. He is not a leap year baby!");
        }
      }
    else {
        console.log("There's nothing special about" + name +"'s birthday. He is not a leap year baby!");
